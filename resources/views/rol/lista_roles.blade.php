                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="POST" id="form1" name="form1" action="{{ route('guardar_rol') }}" enctype="multipart/form-data">
                                        ...
                                        <button type="submit" <?php echo ($accesos['guardar_rol']=='true'?'':'hidden'); ?> onclick="obtener()" class="btn btn-success btn-sm"><i class="fa fa-save"></i>&nbsp;Guardar</button>
                                        @endif
                                        <a class="btn btn-danger btn-sm" id="btn_cancelar" name="btn_cancelar" hidden href="#" onclick="cancelar();"><i class="fa fa-trash-alt"></i>&nbsp;Cancelar</a>
                                    </form>
                                </div>
                            </div>
                        </div>
                                  ...
                                  <tbody>
                                    ...
                                    @foreach($roles as $r)
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                            @if ($accesos['guardar_rol']=='true'  )
                                            <a class="btn btn-primary"  href="#" onclick="editar('{{$r->id_permisos}}','{{$r->nombre_rol}}','{{$r->id_rol}}');" title="Editar"><i class=" fa fa-pencil-square-o"></i></a>
                                            @endif
                                            @if ($accesos['eliminar_roles']=='true')
                                            <a class="btn btn-danger"  href="#" onclick="eliminar('{{$r->id_rol}}');" title="Eliminar"><i class="fa fa-trash"></i></a>
                                            @endif
                                        </td>
                                      </tr>
                                    @endforeach
